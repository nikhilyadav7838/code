...
public class ZeeNewsHomePage extends GenericMobPage{

	public static final String TITLE_OF_HOME_PAGE = "Zee News: Latest News, Live Breaking News, Today News, India Political News Updates";
	...
	public String getCrawlerMenuForZeeNewsIndia() {
		return CRAWLER_MENU_OF_ZEENEWS_INDIA;
	}
	
	public boolean validateHomePageOpened(String url) {
		String childPageURL = driver.getCurrentUrl();
		return childPageURL.contains(url) && isInvisible(INTERNAL_SERVER_ERROR);
	}
	
	public ZeeNewsIndiaPage openTopHeadStory() {
