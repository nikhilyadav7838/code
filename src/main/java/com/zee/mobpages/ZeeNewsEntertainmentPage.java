...
public class ZeeNewsEntertainmentPage extends GenericMobPage {

	private static final String PAGE_HEADER = "//*[@class='pageh1' and contains(text(),'Entertainment News')]";
	...
	public boolean validateEntertainmentPageOpened() {
		...
		return childPageURL.contains(Constants.ZeeNewsIndia.ENTERTAINMENT_IN_URL) && isInvisible(INTERNAL_SERVER_ERROR) && isVisible(PAGE_HEADER);
	}
