...
public class TestNetworkCallsForAMP extends MobUIAction{
	...
	public void test01_ValidateGAandScoreCardCallsForArticleAMPpage(String url) {
		...
		setRequestParamForGAorScoreCard(entries, Constants.GA_CALLS_FOR_MSITE, Constants.COLLECT_URL_ATTRIBUTE, null, null, true);
		...
		setRequestParamForGAorScoreCard(entries, Constants.SCORECARD_CALLS_FOR_MSITE, Constants.C1, null, null, true);
