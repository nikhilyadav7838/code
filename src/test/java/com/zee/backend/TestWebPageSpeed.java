...
public class TestWebPageSpeed extends WebAction{
	...
	public void test01_ValidatePageSpeedOfArticleForWeb(@Optional String url) {
		...
		softAssert.assertEquals(entity.getCoreWebVitalsAssessment(), "Validated, The Core Vitals Assessment has been passed or failed.");
		arrayList.add(entity);
		
		softAssert.assertAll();
	}
	
	@Test(priority = 2, testName = "Validate, Page Speed of a Video on Web", enabled = true)
	@Parameters("URL")
	...
	@Test(priority = 3, testName = "Validate, Page Speed of a Photo Gallery on Web", enabled = true)
	@Parameters("URL")
	...
	public void writeDataInExcel(String jobName) {
		genericUtility.writeDataInWorkbook(workbook, sheet, arrayList, Constants.PAGE_SPEED_EXCEL_NAME, jobName);
	}*/
}
